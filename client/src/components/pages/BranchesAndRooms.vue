    ...
    <div class="border-2 shadow rounded-lg">
      ...
      <div class="p-3">
        <div class="flex justify-end items-center relative">
          <div @click="toggleSortDropdown" id="dropdownBtn"
               class="sort-btn mb-3 cursor-pointer text-gray-500 hover:text-gray-900">Saralash <i
              class="fa fa-chevron-down text-sm"></i></div>
          <div id="dropdownForSort"
               class="z-10 hidden top-7 right-0 absolute bg-white divide-y divide-gray-100 rounded shadow-lg transition ease-in duration-200 w-44 dark:bg-gray-700">
        ...
        <div class="relative bg-white rounded-lg shadow-lg border-2 dark:bg-gray-700">
          ...
          <div class="p-5 pt-8">
            <Form @submit="onSubmit" :validation-schema="schema">
              ...
              <Field name="branch_name" type="text" placeholder="Urganch..." v-model="branch_name"
            ...
            <Form @submit="onSubmitRoom" :validation-schema="roomSchema">
              <Field name="room_name" type="text" placeholder="215 a..." v-model="room_name"
                     class="border rounded block p-2 outline-0 mb-4 w-full"/>
              <ErrorMessage name="room_name" class="error-feedback text-red-600 font-medium"/>
              <Field name="room_amount" type="number" min="0" placeholder="15" v-model="room_amount"
                     class="border rounded block p-2 outline-0 w-20"/>
              <ErrorMessage name="room_amount" class="error-feedback text-red-600 font-medium"/>
              <br/>
              ...
              <button type="submit"
                      class="w-full p-2 text-center block bg-green-500 text-white rounded text-xl hover:bg-green-600 focus:border focus:border-gray-600">
                Xona qo'shish
              </button>
            </Form>
          </div>
