  ...
  <div class="p-3 pr-7 overflow-x-hidden">
    <div class="border-2 shadow rounded-lg">
      <div class="flex justify-between items-center px-3">
        ...
        <i @click="openModal()" class="fa fa-plus cursor-pointer font-serif uppercase font-light p-3 rounded bg-green-500 text-white hover:bg-green-700"> kurs qo`shish</i>
      </div>
      <hr />
      <div class="p-3">
          ...
          <div class="p-5 pt-8">
            <div>
              <Form @submit="onSubmit" :validation-schema="schema">
                ...
                <Field name="course_name" type="text" placeholder="Kurs nomi..." v-model="course_name" class="border rounded block p-2 outline-0 w-full" />
                ...
                <div class="grid grid-cols-2">
                  <div>
                    ...
                    <Field name="duration" type="number" min="1" placeholder="2" v-model="duration" class="border rounded block p-2 outline-0 w-20" />
                  ...
                  <div>
                    ...
                    <Field name="per_lesson" type="number" min="1" placeholder="1" v-model="per_lesson" class="border rounded block p-2 outline-0 w-20" />
                ...
                <Field name="start_date" type="datetime-local" v-model="start_date" class="border rounded block p-2 outline-0 w-72" />
